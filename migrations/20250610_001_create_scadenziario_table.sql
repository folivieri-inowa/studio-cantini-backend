...
CREATE INDEX idx_scadenziario_date ON scadenziario(date);
CREATE INDEX idx_scadenziario_status ON scadenziario(status);
CREATE INDEX idx_scadenziario_owner_id ON scadenziario(owner_id);
