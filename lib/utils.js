...
function getCellValue(cell) {
  ...
  if (cell.t === 'n') {
    // Per le celle numeriche usiamo sempre cell.v (già il numero float corretto).
    // cell.w è la stringa formattata con separatori localizzati (es. "-1,255.00")
    // che causerebbe errori in parseAmount.
    return cell.v;
  }
